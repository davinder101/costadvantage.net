    ...
    <section class="cms-content">
        <div class="cms-content-top zsg-layout-width zsg-md-hide zsg-sm-hide" id="large-upsell">
          <header class="cms-content-hdr">
            <h2 class="cms-content-hdr-text">About Us</h2>
          </header>
          <section class="cms-content-section zsg-sm-hide">
            <div class="zsg-g">
              ...
              <p>Being able to design a sales and marketing strategy that is completely focused and driven by the data available, Cost Advantage ensures that you save not only in terms of money but also in terms of time as well. That means you will surely get the best possible results in the shortest possible time.</p>
              
              <p>Numerous complex aspects of marketing and sales are included along with strategic planning bearing in mind the best possible solution within the least possible investment is the forte of the financial wizards.</p>
